...
namespace HardcoreFramework.Service
{
    public class ComputeEngineCreator
    {
        public static ComputeEngine WithCredentialsFromProperty()
        {
            ...
            {
                return TestDataReader.GetForm("D:/automation-dot-net/HardcoreFramework/HardcoreFramework/Properties/DevConfig.json").Result;
            }
            else if (Environment.GetEnvironmentVariable("enviroment").Equals("qa"))
            {
                return TestDataReader.GetForm("D:/automation-dot-net/HardcoreFramework/HardcoreFramework/Properties/QAConfig.json").Result;
            }
